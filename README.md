...
通过对MYSQL数据库的实时检测，将降价商品加入降价商品表，并采用定时功能选择用户所喜爱的最大降价幅度的商品发送消息通知，用户在登陆后便可以接收到通知，通过便捷的弹窗直接进入支付界面，缩短用户思考时间，增![image](https://user-images.githubusercontent.com/67038748/128482197-b132839a-f9af-4d42-97a2-5ccd5e8d4f8c.png)加用户购买机率，实现卖家收益最大化。
